    ...
    <nav className='flex justify-center py-10'>
      ...
      {pages.map(currentPage => (
        <Link
            ...
            className={`${currentPage === page ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-900'} px-4 py-2 text-sm ring-1 ring-inset ring-gray-300 focus:outline-offset-0`}
        >
          {currentPage}
        </Link>
      ))}
